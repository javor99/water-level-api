...
FIXED: Water_levels table constraints (level_cm nullable)
"""
...
def recreate_exact_db():
    ...
    # Create water_levels table with FIXED constraints (level_cm nullable)
    cursor.execute('''
    ...
    ''')
    print("✅ Water levels table created with FIXED constraints")
    ...
    print("✅ FIXED: water_levels table constraints (level_cm nullable)")
