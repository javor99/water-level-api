...
Deletes all existing tables first, then creates new ones with ALL required columns
"""
...
def init_all_tables():
    ...
    print("🏗️  Creating new tables with ALL required columns...")
    ...
    # Create municipalities table with CORRECT 9 columns
    cursor.execute('''
    ...
    ''')
    print("✅ Municipalities table created with 9 columns")
    
    # Create stations table with ALL required columns including 30-day columns
    cursor.execute('''
    ...
    ''')
    print("✅ Stations table created with 30-day columns")
    
    # Create water_levels table with ALL required columns
    cursor.execute('''
    ...
    ''')
    print("✅ Water levels table created with ALL required columns")
    ...
    ''')
    print("✅ Predictions table created with ALL required columns")
    ...
    conn.commit()
    conn.close()
    print("🎉 All tables initialized successfully with COMPLETE schema!")
    print("✅ Includes ALL required columns:")
    print("   - Municipalities: 9 columns (id, name, region, population, area_km2, description, created_at, created_by, updated_at, updated_by)")
